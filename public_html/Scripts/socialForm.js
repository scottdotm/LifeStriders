$(document).ready(function (e) {
    ...
    $('#printPreviewButton').click(function (e) {
        ...
        $('#ppPHHEnrolling').html($('#PHHenrolling').val());
        $('#ppPHHFunction').html($('#PHHfunction').val());
        $('#ppPHHSocial').html($('#PHHsocial').val());
        $('#ppPHHGoal1').html($('#PHHgoal1').val());
        $('#ppPHHGoal2').html($('#PHHgoal2').val());
        $('#ppPHHGoal3').html($('#PHHgoal3').val());
        $('#ppPHHSocialSuccess').html($('#PHHsocialSuccess').val());
        $('#ppPHHSocialStruggle').html($('#PHHsocialStruggle').val());
        $('#ppPHHTriggers').html($('#PHHtriggers').val());
        $('#ppPHHSensitive').html($('#PHHsensitive').val());
        $('#ppPHHMotivate').html($('#PHHmotivate').val());
        ...
        $('#ppPHHParent').html($("input[name='PHHparent']:checked").val());
        $('#ppPHHAdditional').html($('#PHHadditional').val());
        ...
        $('html,body').scrollTop(0);
        $('#printPreviewSocialFormOVER').show();
        $('#formSocialForm').hide();
    });

    // Captures the print preview print area and sends it to the printer
    $("#printButtonSF").click(function () {
        var mode = 'iframe';
        var close = mode === "popup";
        var options = {mode: mode, popClose: close};
        $("#printPreviewSocialForm").printArea(options);
